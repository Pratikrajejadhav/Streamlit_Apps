...
st.title("Model APP Using streamlit")
...
st.sidebar.header("Let's start with binary classfication")
...
if uploaded_file is not None:
    ...
    selected_columns = st.sidebar.multiselect("Select Target Columns", df.columns.tolist())
